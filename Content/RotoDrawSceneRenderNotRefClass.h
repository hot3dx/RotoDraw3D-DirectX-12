...
namespace RotoDraw3DX12_2
{
	// This sample renderer instantiates a basic rendering pipeline.
	class RotoDrawSceneRender
	{
	...
	public:
		...
		void XM_CALLCONV DrawPointsOne(float positiontX, float positionY);
		bool                           is3DVisible;
	...
	private:
		...
		enum Descriptors
		{
		  ...
		  std::unique_ptr<RotoDraw3DX12_2::CHot3dxD3D12Geometry> m_geo;
		  struct Tetras
		  {
			  std::unique_ptr<DirectX::GeometricPrimitive>                   m_shapeTetra;
		  };
