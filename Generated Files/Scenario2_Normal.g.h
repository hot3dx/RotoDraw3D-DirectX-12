...
namespace Hot3dxRotoDraw
{
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::Slider^ IDC_TEXTURE_UV_SLIDER;
        private: ::Windows::UI::Xaml::Controls::CheckBox^ IDC_HORIZONTAL_LINE_checkBox;
        private: ::Windows::UI::Xaml::Controls::CheckBox^ IDC_VERTICAL_LINE_checkBox;
        private: ::Windows::UI::Xaml::Controls::CheckBox^ IDC_45_DEGREE_LINE_Checkbox;
        private: ::Windows::UI::Xaml::Controls::TextBlock^ IDC_RADIUS_LINE_CENTER_textBlock;
        private: ::Windows::UI::Xaml::Controls::CheckBox^ IDC_ARC_RADIUS_LINE_checkBox;
        private: ::Windows::UI::Xaml::Controls::TextBlock^ IDC_ARC_RADIUS_CENTER_textBlock;
        ...
        private: ::Windows::UI::Xaml::Controls::CheckBox^ IDC_COLOR_ONLY_NO_TEXTURE_CHECKBOX;
        ...
        private: ::Windows::UI::Xaml::Controls::Button^ SAVE_PTS_button;
        private: ::Windows::UI::Xaml::Controls::Button^ PUT_COPY_PTS_button;
        private: ::Windows::UI::Xaml::Controls::Button^ CLEAR_COPED_PTS_button;
        private: ::Windows::UI::Xaml::Shapes::Rectangle^ IDC_CLIP_STATIC2;
        private: ::Windows::UI::Xaml::Controls::Button^ IDC_CLEAR_BUTTON;
        private: ::Windows::UI::Xaml::Controls::Button^ CursorLockResetButton;
